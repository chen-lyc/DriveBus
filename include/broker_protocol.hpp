...
inline constexpr size_t kStatusQuerySize = sizeof(BrokerMessageType);
inline constexpr size_t kMaxStatusSnapshotPayloadSize = 4095;
inline constexpr size_t kMaxStatusSnapshotMessageSize = sizeof(BrokerMessageType) + kMaxStatusSnapshotPayloadSize;

// 订阅者注册包最多携带 5 个 topic_id，topic_count 指定有效个数。
inline constexpr size_t kMaxSubscriberTopicCount = 5;
